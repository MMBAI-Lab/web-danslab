    ...
    <div className="mx-auto max-w-5xl px-6 py-24">
      ...
      <FadeIn delay={0.05}>
        <div className="mt-10 max-w-prose space-y-5 leading-relaxed text-muted">
          <p>
            The ABC 2023 conference is a venue to discuss subjects surrounding
            the sequence-dependent physical properties of DNA, new methods and
            new models, with a multiscale perspective. From the shorter
            atomistic scale to more biologically pertinent length scales
            (mesoscale), i.e. from electrons to nucleosomes.
          </p>
          <p>
            Top international researchers, ABC members, and collaborators from
            diverse fields — experimentalists, computational chemists/physicists,
            and developers of new methods — converge to discuss:
          </p>
        </div>
      </FadeIn>
      ...
      <FadeIn>
        ...
        <div className="mt-6 grid gap-8 md:grid-cols-2">
          <CommitteeList title="Scientific" people={COMMITTEE_SCIENTIFIC} />
          <CommitteeList title="Organizing" people={COMMITTEE_ORGANIZING} />
        </div>
      </FadeIn>
