...
const en: CommonDict = {
  ...
  collaborators: {
    ...
    map_caption: "Every city where we have a collaborator — hover a dot for details.",
  },
  courses: {
    intro:
...
const es: CommonDict = {
  ...
  collaborators: {
    ...
    map_caption: "Cada ciudad donde tenemos un colaborador — pasá el mouse sobre un punto para ver los detalles.",
  },
  courses: {
    intro:
