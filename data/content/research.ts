...
const en: ResearchContent = {
  ...
  bacterial_paragraphs: [
    "Together with Dr. Germán M. Traglia we run a parallel research line on the genomics and molecular biology of antimicrobial resistance, with a particular focus on ESKAPE pathogens — Klebsiella pneumoniae, Acinetobacter baumannii, Pseudomonas aeruginosa and related Enterobacterales. We follow how clinical isolates evolve under last-resort antibiotics such as cefiderocol, ceftazidime/avibactam and ampicillin/sulbactam, characterising the genetic and metabolic determinants behind resistance, hetero-antagonism and the emergence of small-colony variants.",
    "Combining whole-genome sequencing, comparative genomics, transcriptomics and structural modelling, we map the spread of carbapenemases (NDM, KPC, OXA-type) across hospital outbreaks in Latin America, dissect mechanisms of spontaneous resistance in vitro, and probe non-canonical drivers — host factors such as serum albumin or vitamin B12, mobile genetic elements, and the rewiring of central metabolism. The goal is to translate that mechanistic insight into actionable knowledge for clinical surveillance and the design of next-generation combination therapies.",
  ],
...
const es: ResearchContent = {
  ...
  bacterial_paragraphs: [
    "Junto al Dr. Germán M. Traglia desarrollamos una línea paralela centrada en la genómica y la biología molecular de la resistencia antimicrobiana, con foco en patógenos ESKAPE — Klebsiella pneumoniae, Acinetobacter baumannii, Pseudomonas aeruginosa y enterobacterias afines. Seguimos cómo evolucionan los aislamientos clínicos bajo antibióticos de último recurso como cefiderocol, ceftazidima/avibactam y ampicilina/sulbactam, y caracterizamos los determinantes genéticos y metabólicos detrás de la resistencia, el hetero-antagonismo y la aparición de variantes de colonia pequeña.",
    "Combinando secuenciación completa de genoma, genómica comparativa, transcriptómica y modelado estructural, mapeamos la diseminación de carbapenemasas (NDM, KPC, OXA) en brotes hospitalarios de América Latina, diseccionamos mecanismos de resistencia espontánea in vitro y exploramos factores no canónicos —desde elementos del huésped como la albúmina sérica o la vitamina B12 hasta elementos genéticos móviles y la reprogramación del metabolismo central. El objetivo es traducir esa información mecanística en herramientas concretas para la vigilancia clínica y el diseño de terapias combinadas de próxima generación.",
  ],
