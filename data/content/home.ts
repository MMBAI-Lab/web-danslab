...
const es: HomeContent = {
  ...
  about_paragraphs: [
    `El Dans Lab, también conocido como el grupo de <strong class="text-ink">Modelado Molecular, Bioinformática e IA (MMBAI)</strong>, es parte del <a class="text-accent underline-offset-4 hover:underline" target="_blank" rel="noreferrer" href="https://dcb.litoralnorte.udelar.edu.uy/">Departamento de Ciencias Biológicas (DCB)</a> del <a class="text-accent underline-offset-4 hover:underline" target="_blank" rel="noreferrer" href="https://www.litoralnorte.udelar.edu.uy/">Centro Universitario Regional (CENUR)</a> en Salto, en el Litoral Norte de Uruguay.`,
