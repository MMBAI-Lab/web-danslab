...
const en: HomeContent = {
  ...
  about_paragraphs: [
    "The Dans Lab, also known as the Molecular Modeling, Bioinformatics and AI group, is part of the Department of Biological Sciences (DCB) at the Regional University Center (CENUR) in Salto, located in the northern riverside region of Uruguay (Litoral Norte).",
...
const es: HomeContent = {
  ...
  about_paragraphs: [
    "El Dans Lab, también conocido como el grupo de Modelado Molecular, Bioinformática e IA, es parte del Departamento de Ciencias Biológicas (DCB) del Centro Universitario Regional (CENUR) en Salto, en el Litoral Norte de Uruguay.",
